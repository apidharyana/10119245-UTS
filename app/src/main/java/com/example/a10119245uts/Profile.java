    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnWa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String url = "https://api.whatsapp.com/send?phone=+6289012345678";
        ...
        btnFb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://facebook.com/apidharyana"));
                startActivity(intent);
            }
        });
        ...
        btnMail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String email = "example.apidharyana@gmail.com";
        ...
        location.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String url = String.format(Locale.ENGLISH, "geo:%f, %f", -6.888923, 107.617013);
